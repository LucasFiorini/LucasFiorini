...
Exploring **Instance Hardness metrics** to enhance model training and/or feature engineering. Building hardness-informed approaches that adapt modeling effort to where it has the biggest problems with.
